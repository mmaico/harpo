...
class BootstrapNode(private val _connectionInfo: ConnectionInfoImpl, private val _id: BigInteger, private var _lastSeen: Date?) : Node<BigInteger, ConnectionInfoImpl> {
