...
class External(id: BigInteger, distance: Int = 0, lastSeen: Long, contact: Contact): Node(id, distance, lastSeen, contact)

class Self(id: BigInteger, distance: Int = 0, lastSeen: Long , contact: Contact): Node(id, distance, lastSeen, contact) {
